...
public class GithubApi {
    ...
    public Map<Language, BigDecimal> getBytesPerLanguage() {
        Map<Language, BigDecimal> bytesPerLanguage = new HashMap<>();
        for (Repository repository : repositories) {
            for (Language language : repository.getLanguages()) {
                bytesPerLanguage.put(language, BigDecimal.ZERO);
            }
        }
        ...
        for (Repository repository : repositories) {
            for (Language language : repository.getLanguages()) {
                ...
                bytesPerLanguage.put(language, cumulate);
            }
        }
        System.out.println("bytesPerLanguage: " + bytesPerLanguage);
        return Maps.newHashMap(bytesPerLanguage);
    }
